...
describe('fetchProducts', () => {
  ...
  it('normalizes OneDrive share URLs from alternate paths', async () => {
    const onedriveShareUrl =
      'https://1drv.ms/i/s!ApssMGmzZbV9gYQbJwsLg7cXMVvUYQ?e=abc123'
    const expectedNormalizedUrl =
      'https://1drv.ms/i/c/3150482359d620a2/s!ApssMGmzZbV9gYQbJwsLg7cXMVvUYQ?width=1080&height=1350'

    const csvResponse = [
      'id;name;description;price;image;category;subcategory;image2;image3;image4;image5;Fabricante;codigo-fabricante;referencia-produto',
      `1;Produto;Descrição;100;${onedriveShareUrl};Categoria;Subcategoria;;;;;Fabricante;COD-2;REF-2`,
    ].join('\n')
    ...
    expect(data).toEqual([
      {
        ...
        price: 100,
        image: expectedNormalizedUrl,
        images: [expectedNormalizedUrl],
        category: 'Categoria',
        subcategory: 'Subcategoria',
        manufacturer: 'Fabricante',
        manufacturerCode: 'COD-2',
        productReference: 'REF-2',
      },
    ])
  })
})
